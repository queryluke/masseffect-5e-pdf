...
Your omni-tool is the source of your spellcasting capabilities. See chapter 10 for the
...
<img 
  src='https://github.com/queryluke/masseffect-5e-pdf/blob/master/images/drone_art.png?raw=true' 
  style='position:absolute; bottom:50px; left:70px; width:600px' />

<div style='position:absolute; bottom: 30px; right: 20px; width: 325px;'>
_[Jupiter Hell - Drone concept art by EwaLabak](https://www.deviantart.com/ewalabak/art/Jupiter-Hell-Drone-concept-art-650277235)_
</div>
...
<img 
  src='https://github.com/queryluke/masseffect-5e-pdf/blob/master/images/omni-glove.png?raw=true' 
  style='width:800px; position: absolute; left: 10px; bottom: -30px' />

<div style='position:absolute; bottom: 30px; right: 20px; width: 325px;'>
_[Omni Glove - Communication Briefer by Eric Bellefeuille](https://index.artstation.com/artwork/Qkbv3)_
</div>
